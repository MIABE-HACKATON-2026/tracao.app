...
import { BuyerScanIcon } from "../components/buyer-icons";
        ...
        <div className="w-full h-full flex flex-col gap-5">
            <div className="flex justify-between items-center">
                <div className="flex flex-col items-start gap-1">
                    ...
                    <p className="text-[12px] leading-[16px] text-cocoa-60">Scannez un lot pour vérifier son authenticité</p>
                </div>
            </div>
            ...
            <div className="flex-1 w-full rounded-[16px] bg-cocoa-5 p-6 flex flex-col items-center justify-center gap-6">
                <div className="w-[280px] h-[280px] rounded-[24px] bg-white border-2 border-dashed border-cocoa-20 flex items-center justify-center">
                    <BuyerScanIcon className="h-32 w-32 fill-cocoa-10" />
                </div>
                <p className="text-[14px] text-cocoa-40 text-center max-w-md">
                    Scannez le QR code d'un lot importé pour vérifier instantanément son authenticité et sa conformité
                </p>
                ...
                <div className="w-full max-w-md bg-white rounded-[16px] p-4 flex items-center gap-3 border border-[#C8E6C9]">
                    ...
                    <div className="flex flex-col">
                        <span className="text-[14px] text-cocoa font-medium">TRC-2026-0001 · Authentique</span>
                        <span className="text-[12px] text-cocoa-40">Hash blockchain vérifié · Cacao certifié</span>
                    </div>
                    <button className="ml-auto h-[34px] px-4 rounded-[8px] bg-cocoa-5 text-[12px] text-cocoa font-medium hover:bg-cocoa-10 cursor-pointer">
                        Voir
                    </button>
                </div>
            </div>
