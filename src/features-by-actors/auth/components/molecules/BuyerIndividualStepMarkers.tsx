...
import type { BuyerIndividualSteps } from "../../layouts/AccountCreationStepLayout"

interface StepValidation {
  id: number;
  step: Partial<BuyerIndividualSteps>;
  Label: string;
  status: 'validate' | 'current' | 'incomming' | 'otpCode'
}
const BuyerIndividualStepMarkers = ({ step }: { step: BuyerIndividualSteps }) => {
  const [steps, setSteps] = useState<StepValidation[]>([
    {
      id: 1,
      Label: "Infos de l'acheteur",
      step: "individualInfo",
      status: "incomming",
    },
    {
  ...
  return (
    <div className="flex flex-col items-start gap-2.5">
      <div className="text-cocoa-70 text-[12px] leading-[18px]" >Compte ache. indviduel</div>
...
export default BuyerIndividualStepMarkers