...
const BuyerIndividualPersonalInfosPage = () => {
    ...
    const submitPersonalInfo = () => {
        if (!firstName.trim() || !lastName.trim() || !location?.city || !location?.country || !location?.latitude) {
...
export default BuyerIndividualPersonalInfosPage
