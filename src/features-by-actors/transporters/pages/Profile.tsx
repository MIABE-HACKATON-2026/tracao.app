        ...
        <div className="w-full h-full flex flex-col gap-5">
            <div className="flex justify-between items-start">
                <div className="flex flex-col items-start gap-1">
                    ...
                    <p className="text-[12px] leading-[16px] text-cocoa-60">Informations personnelles</p>
                </div>
            </div>
            ...
            <div className="flex-1 w-full rounded-[16px] bg-cocoa-5 p-8 flex flex-col items-center gap-8 overflow-y-auto">
                <div className="flex items-center gap-5">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <span className="text-[13px] text-cocoa-40">Transporteur</span>
                        <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-[6px] bg-cocoa-10 text-[11px] text-cocoa-60 mt-1">
                            Actif
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-[600px] w-full flex flex-col gap-5">
                    ...
                    <Input variant="password" label="Confirmer" placeholder="Confirmer le mot de passe" />
